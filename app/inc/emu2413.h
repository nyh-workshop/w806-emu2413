...
constexpr double DEFAULT_SAMPLE_RATE = 22050.00f;

//#define MSX_CLK 3579545
constexpr double MSX_CLK = 3579545.00f;
...
void OPLL_RateConv_new(OPLL_RateConv* conv, const double f_inp, const double f_out, int ch);
